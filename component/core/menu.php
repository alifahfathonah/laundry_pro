...
<li>
                                    <a href="add_pelanggan"><i class="fa fa-circle-o"></i>Tambah Pelanggan</a>
                                                  ...
                                                  <li>  <li class="treeview">
                                                                                      <a href="#"><i class="fa fa-circle-o"></i>Komplain Pelanggan</a>
                                                                                      	 <ul class="treeview-menu">
                                                                                           <li>
                                                                                               <a href="komplain"><i class="fa fa-circle-o"></i>Data Komplain</a>
                                                                                           </li>
                                                                                           <li>
                                                                                               <a href="add_komplain"><i class="fa fa-circle-o"></i>Tambah Komplain</a>
                                                                                           </li>
                                                                                         </ul>
                                                                                                    </li>
                                                                                                  </li>
  ...
  if($chmenu8 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
                          ...
                          <li class="treeview">
                              <a href="#"> <i class="glyphicon glyphicon-stats"></i> <span>Laporan</span> <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i> </span> </a>
  							 <ul class="treeview-menu">
                                  <li>
                                      <a href="report_trx"><i class="fa fa-circle-o"></i>Transaksi</a>
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                      <a href="report_lunas"><i class="fa fa-circle-o"></i>Transaksi Lunas</a>
                                  </li>
                                  <li>
                                      <a href="report_blunas"><i class="fa fa-circle-o"></i>Transaksi Belum Lunas</a>
                                  </li>
                                  <li>
                                      <a href="report_customer"><i class="fa fa-circle-o"></i>Transaksi PerPelanggan</a>
                                  </li>
                                  <li>
                                      <a href="report_admin"><i class="fa fa-circle-o"></i>Transaksi PerAdmin</a>
                                  </li>
                                  <li>
                                      <a href="toplist"><i class="fa fa-circle-o"></i>Top List</a>
                                  </li>
...
if($chmenu9 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
                            ...
                            <a href=""> <i class="glyphicon glyphicon-cog"></i> <span>Pengaturan</span> <span class="pull-right-container"> </span> </a>
								...
								<a href="set_chmod"><i class="fa fa-circle-o"></i>Hak Akses</a>
                                                  ...
                                                  <li>
                                                                                      <a href="loglogin"><i class="fa fa-circle-o"></i>History Login</a>
                                                                                                    </li>
                            </ul>
                        </li>
<?php }else{} ?>
