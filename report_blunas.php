                  ...
                  <div class="row">
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-aqua">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($datax12, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Semua</p>
                                           </div>
                                           <div class="icon">
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-yellow">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($datax22, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Tahun Ini</p>
                                           </div>
                                           <div class="icon">
                                              <i class="ion ion-stats-bars"></i>
                    ...
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-green">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($datax32, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Bulan Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-red">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($datax42, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Hari Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
...
$halaman = "report_blunas"; // halaman
$dataapa = "Laporan Laundry Belum Lunas"; // data
...
if($tahun == null || $tahun == "" ){
        ...
        $sqla="SELECT no, COUNT( * ) AS totaldata FROM $forward where nota IN (SELECT nota FROM transaksimasuk) and tglmasuk LIKE '$tahun-$bulan-%' and status!='lunas'";
      }
...
?>
  ...
  <?php
$sqlb="SELECT SUM(total) AS total FROM $forward WHERE nota IN (SELECT nota FROM transaksimasuk) AND tglmasuk LIKE '$tahun-$bulan-%' and status!='lunas'";
...
<?php if($tahun != null || $tahun != ""){ ?>
                    ...
                    <?php echo 'Total Belum Lunas pada bulan <b>'.$namabulan.'</b> '.$tahun.' sejumlah <b>Rp '.number_format($totalrevenue, $decimal, $a_decimal, $thousand).',-</b>'; ?>
                </div>
                  <?php }else{} ?>
</div>
                </div>
     ...
     $sql    = "SELECT * FROM  $forward where nota IN (SELECT nota FROM transaksimasuk) and tglmasuk like '$tahun-$bulan-%' and status!='lunas' order by no desc";
 ...
 ?>
     ...
     if ($tahun != null || $tahun != "") {
         ...
         $query1="SELECT * FROM  $forward where nota IN (SELECT nota FROM transaksimasuk) and tglmasuk like '$tahun-$bulan-%' and status!='lunas' order by no limit $rpp";
  ...
  <div align="right"><?php if($tcount>=$rpp){ echo paginate_one($reload, $page, $tpages);}else{} ?></div>
   ...
   <?php } ?>
             ...
             <div align="left" class="no-print" id="no-print"> <a onclick="javascript:printDiv('tabel1');" class="btn btn-default btn-flat" name="cetak" value="cetak"><span class="glyphicon glyphicon-print"></span></a><?php echo " "; ?>
               <a onclick="window.location.href='configuration/config_export?forward=blunas&search=&bulan=<?php echo $bulan; ?>&tahun=<?php echo $tahun; ?>'" class="btn btn-default btn-flat" name="cetak" value="export excel"><span class="glyphicon glyphicon-save-file"></span></a></div> <br/>
             </div>
                        </div>
                        <!-- ./col -->
                    </div>
