                       ...
                       <div class="col-lg-3 col-xs-6">
                         ...
                         <div class="small-box bg-green">
                             ...
                             <div class="icon">
                               ...
                               <a href="pelanggan" class="small-box-footer">Info lengkap <i class="fa fa-arrow-circle-right"></i></a>
                         </div>
                     </div>
                     ...
                     <div class="col-lg-3 col-xs-6">
                       ...
                       <div class="small-box bg-yellow">
                           ...
                           <div class="icon">
                             ...
                             <a href="jenis" class="small-box-footer">Info lengkap <i class="fa fa-arrow-circle-right"></i></a>
                       </div>
                   </div>
                   ...
                   <div class="col-lg-3 col-xs-6">
                     ...
                     <div class="small-box bg-red">
                         ...
                         <div class="icon">
                           ...
                           <a href="satuan" class="small-box-footer">Info lengkap <i class="fa fa-arrow-circle-right"></i></a>
                     </div>
                 </div>
                     ...
                     <div class="row">
                          ...
                          <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3><?php echo $dataxx1; ?><sup style="font-size: 20px">Kg</sup></h3>
                                    <p>Laundry Hari Ini</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-xs-6">
                          ...
                          <div class="small-box bg-info">
                              <div class="inner">
                                  <h3><?php echo $dataxx2; ?><sup style="font-size: 20px">M</sup></h3>
                                  <p>Karpet Hari Ini</p>
                              </div>
                              <div class="icon">
                    ...
                    <div class="col-lg-3 col-xs-6">
                      ...
                      <div class="small-box bg-warning">
                          <div class="inner">
                              <h3><?php echo $dataxx4; ?></h3>
                              <p>Total Nota Berhasil</p>
                          </div>
                          <div class="icon">
                              <i class="ion-document-text"></i>
                          </div>
